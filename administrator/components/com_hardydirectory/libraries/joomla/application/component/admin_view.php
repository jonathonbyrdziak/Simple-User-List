...
class AdminView extends JView
{
     ...
     * @return array
     */
    protected function getList( $filter = null, $limit = null )
    {
    	//loading resources
    	$models =& JTable::getInstance($this->_table, 'Table');
    	
    	//initializing variables
    	$list = $models->getList( $filter, $limit );
     ...
     * 
     */
    protected function _list( $path = null, $record_type = null, $limit = null )
    {
    	//loading resources
    	...
    	{
    		$records = $this->getList( null, $limit );
    	}
