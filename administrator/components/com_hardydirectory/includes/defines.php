...
//components name
define( 'EBOOK_COMPONENT', 		'com_hardydirectory' );

//this url
$parts = parse_url(JURI::base());
define( 'DOTCOM',				JURI::base() );
...
define( 'EBOOK_EVERY', 			EBOOK_LIB.DS.'byrd' );
...
define( 'DOT_IMG',				DOTCOM.'components/'.EBOOK_COMPONENT.'/media/images/');
